...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: testInsertReadDb Weather Query Validation Failed", weatherCursor, weatherValues);
        // Move the cursor to demonstrate that there is only one record int he database
