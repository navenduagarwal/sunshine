...
public class Utility {
    ...
    public static String formatTemperature(Context context, double temperature) {
        //Date stored in Celsius by default . If user prefers to see in Fahrenheit, conver
        //the values here
    ...
    static String friendlyDateFormat(Context context, long dateInMillis) {
        Time time = new Time();
        time.setToNow();
     ...
     * @param context Context for retrieving preferences
